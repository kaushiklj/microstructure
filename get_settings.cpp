...
void get_settings(settings& settings_list1){
     ...
     if(myfile){
        while (getline(myfile,line)){
               ...
               if (temp[0] == "molecule_flag"){
                   settings_list1.molecule_flag = atoi(temp[1].c_str());
               }
               if (temp[0] == "table_flag"){
                   settings_list1.table_flag = atoi(temp[1].c_str());
               }
               if (temp[0] == "c3_flag"){
                   settings_list1.c3_flag = atoi(temp[1].c_str());
               }
               if (temp[0] == "ring_flag"){
               ...
               if (temp[0] == "saturate_H_flag"){
                   settings_list1.saturate_H_flag = atoi(temp[1].c_str());
               }
